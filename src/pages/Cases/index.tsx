  ...
  return (
    <PageContainer ghost title={false}>
      <div className="container">
        <div className="case-title-content box">
        ...
        <div className="case">
          ...
          <div className="right">
            <div className="case-name">青田县水环境智慧监测平台</div>
            <div className="case-content">
              <p>通过智能水环境监测系统，能够全面掌握青田县水资源状态，基于系统提供的各类分析模型实时预测预警污染源排放情况，为环境治理的相关工作部署提供有力的技术支撑。</p>
            </div>
            {/* <Button size="large" onClick={showModal1}>系统详情</Button> */}
            <Button size="large"><a href='http://183.245.140.144:8000/#/login'>访问系统</a></Button>
          </div>
        </div>
        <Modal title="青田县水环境智慧监测平台" open={isModal1Open} onCancel={handleCancel} footer={null}>
          <p>通过智能水环境监测系统，能够全面掌握青田县水资源状态，基于系统提供的各类分析模型实时预测预警污染源排放情况，为环境治理的相关工作部署提供有力的技术支撑。</p>
        </Modal>
        <div className="case">
          <div className="left">
